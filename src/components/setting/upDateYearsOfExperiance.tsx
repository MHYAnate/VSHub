...
export default function UpDateYearsOfExperience({ docId }: Props) {
	...
	const handleUpdateYearsOfExperience = async (data: ProfileValues) => {
		try {
	...
	const onSubmit = (data: ProfileValues) => {
		handleUpdateYearsOfExperience(data);
	};

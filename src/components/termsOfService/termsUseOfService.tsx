...
const TermsUseOfService: React.FC = () => {
    ...
    <p className="mb-4">
      Sspot1 provides a platform for vendors to offer their services and for clients to discover and engage these services. Users must use the platform in compliance with all applicable laws and regulations.
    </p>
    <ul className="list-disc pl-5 mb-4 space-y-2">
      <li>Users must be at least 18 years old to use Sspot1.</li>

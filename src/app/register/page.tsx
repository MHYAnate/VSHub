...
export default function RegisterLanding() {
	...
	return (
		<div>
			...
			<div className="min-h-screen bg-gradient-to-br from-gray-100 to-gray-300 flex flex-col justify-center items-center p-4 mt-20">
				<div className="w-full max-w-2xl bg-white shadow-xl rounded-lg overflow-hidden">
					...
					<div className="p-6">
						...
						{activeTab === "vendor" && <VendorRegComponent />}
						{activeTab === "client" && <RegComponent />}
					</div>
				</div>
